...
public class SOSdescribeSensorTest {
    ...
    private static final String bdss_1_query = "procedure=urn:ioos:station:sos:NOAA_8779748";
    private static final String bdss_watlev_query = "procedure=urn:ioos:sensor:sos:NOAA_8724698:watlev";
    private static final String bdss_1_query_bad = "procedure=urn:ioos:station:sos:badstationname";
    ...
    private static final String bdss_2_query = "procedure=urn:ioos:station:sos:Station1";
    private static final String bdss_2_bad_sensor = "procedure=urn:ioos:sensor:sos:Station1:badsensor";
    ...
    private static final String bdst_1_query = "procedure=urn:ioos:station:sos:Trajectory3";
    private static final String bdst_1_query_bad = "procedure=urn:ioos:station:sos:Trajectory100";
    ...
    private static final String bdst_2_query = "procedure=urn:ioos:station:sos:Trajectory7";
    ...
    private static final String bdsp_1_query = "procedure=urn:ioos:station:sos:Profile3";
    private static final String bdsp_1_query_bad = "procedure=urn:ioos:station:sos:Profile100";
    ...
    private static final String bdsp_2_query = "procedure=urn:ioos:station:sos:Profile5";
    ...
    private static final String bdsp_3_query = "procedure=urn:ioos:station:sos:Profile32";
    
    private static final String bdsg_1_set = "resources/datasets/satellite-sst/SST_Global_2x2deg_20120626_0000.nc";
    private static final String bdsg_1_query = "procedure=urn:ioos:station:sos:Grid0";
    ...
    private static final String bdstp_1_query = "procedure=urn:ioos:station:sos:Trajectory2";
    private static final String bdstp_1_query_bad = "procedure=urn:ioos:station:sos:Trajectory200";
    ...
    private static final String bdstp_2_query = "procedure=urn:ioos:station:sos:Trajectory3";
    
    private static final String ext_hawaii_set = "resources/datasets/sura/wqbkn_2012_08_01.nc";
    private static final String ext_hawaii_query = "procedure=urn:ioos:station:sos:WQBKN";
    
    private static final String andrw_set = "resources/datasets/sura/andrw.lft.nc";
    private static final String andrw_query = "procedure=urn:ioos:station:sos:Site-79-2";
    
    private static final String usace_set = "resources/datasets/sura/hs_USACE-CHL.nc";
    private static final String usace_query = "procedure=urn:ioos:station:sos:USACE-CHL_2410504B";
    
    private static final String undkennedy_set = "resources/datasets/sura/Hsig_UNDKennedy_IKE_VIMS_3D_WAVEONLY.nc";
    private static final String undkennedy_query = "procedure=urn:ioos:station:sos:UNDKennedy_R";
    
    private static final String hwm_tcoon_set = "resources/datasets/sura/hwm_TCOON_NAVD88.nc";
    private static final String hwm_tcoon_query = "procedure=urn:ioos:station:sos:TCOON_8779770";
    
    private static final String tm_csi_set = "resources/datasets/sura/tm_CSI.nc";
    private static final String tm_csi_query = "procedure=urn:ioos:station:sos:CSI_03";
    
    private static final String tm_ike_set = "resources/datasets/sura/tm_IKE.nc";
    private static final String tm_ike_query = "procedure=urn:ioos:station:sos:CSI_09";
    
    private static final String crms_set = "resources/datasets/sura/watlev_CRMS.nc";
    private static final String crms_query = "procedure=urn:ioos:station:sos:CRMS_BA04-07";
    
    private static final String crms_2005_set = "resources/datasets/sura/watlev_CRMS_2005.nc";
    private static final String crms_2005_query = "procedure=urn:ioos:station:sos:CRMS_BA04-10";
    
    private static final String crms_2008_set = "resources/datasets/sura/watlev_CRMS_2008.F.C__IKE_VIMS_3D_WITHWAVE.nc";
    private static final String crms_2008_query = "procedure=urn:ioos:station:sos:CRMS_BA04-56";
    
    private static final String crms_2008_nowave_set = "resources/datasets/sura/watlev_CRMS_2008.F.C_IKE_VIMS_3D_NOWAVE.nc";
    private static final String crms_2008_nowave_query = "procedure=urn:ioos:station:sos:CRMS_BS08-09";
    
    private static final String crms_2008_basecycle_set = "resources/datasets/sura/watlev_CRMS_2008.F.C_mod_base_cycle_5.nc";
    private static final String crms_2008_basecycle_query = "procedure=urn:ioos:station:sos:CRMS_CS20-03";
    
    private static final String watlev_csi_set = "resources/datasets/sura/watlev_CSI.nc";
    private static final String watlev_csi_query = "procedure=urn:ioos:station:sos:CSI_15";
    
    private static final String watlev_ike_set = "resources/datasets/sura/watlev_IKE.nc";
    private static final String watlev_ike_query = "procedure=urn:ioos:station:sos:CRMS_BA01-01";
    
    private static final String watlev_ike_61_set = "resources/datasets/sura/watlev_IKE.P.UL-Ike2Dh.61.nc";
    private static final String watlev_ike_61_query = "procedure=urn:ioos:station:sos:USACE-CHL_2410504B";
    
    private static final String watlev_noaa_set = "resources/datasets/sura/watlev_NOAA.F.C.nc";
    private static final String watlev_noaa_query = "procedure=urn:ioos:station:sos:NOAA_8724698";
    
    private static final String noaa_navd_set = "resources/datasets/sura/watlev_NOAA_NAVD_PRE.nc";
    private static final String noaa_navd_query = "procedure=urn:ioos:station:sos:NOAA_8726347";
    
    private static final String jason_satellite_set = "resources/datasets/nodc/jason2_satelliteAltimeter.nc";
    private static final String jason_satellite_query = "procedure=urn:ioos:station:sos:unknown";
    
    private static final String bodega_marinelab_set = "resources/datasets/nodc/BodegaMarineLabBuoy.nc";
    private static final String bodega_marinelab_query = "procedure=urn:ioos:station:sos:CordellBankBuoy";
    ...
    private static final String bad_request_control_query = "procedure=urn:ioos:station:sos:Trajectory2";
    ...
    private static final String bad_request_procedure_misspelled_query = "request=DescribeSensor&service=sos&version=1.0.0&procdure=urn:ioos:station:sos:trajectory2&responseformat=";
    ...
    public void testBasicDescribeSensorStation() throws IOException {
        ...
        assertTrue("station id not as expected", writer.toString().contains("<sml:value>urn:ioos:station:sos:NOAA_8779748</sml:value>"));
...
//        assertTrue("missing/invalid altitude", writer.toString().contains("<swe:value>9.813936233520508</swe:value>"));
    ...
    public void testBasicDescribeSensorSensor() throws IOException {
        ...
        assertTrue("missing/invalid sensor id", writer.toString().contains("<sml:value>urn:ioos:sensor:sos:NOAA_8724698:watlev</sml:value>"));
        // write as an example
