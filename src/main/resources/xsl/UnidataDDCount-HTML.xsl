...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:nc="http://www.unidata.ucar.edu/namespaces/netcdf/ncml-2.2">
	...
	<xsl:template match="/">
		...
		<html>
			...
			The Unidata Attribute Convention for Data Discovery provides recommendations for netCDF
			attributes that can be added to netCDF files to facilitate discovery of those files
			using standard metadata searches. This tool tests conformance with those
			recommendations. More <a href="https://www.nosc.noaa.gov/dmc/swg/wiki/index.php?title=NetCDF_Attribute_Convention_for_Dataset_Discovery#Conformance_Test">Information on Convention and Tool</a>. <h2> Title: <xsl:value-of select="$titleAttribute/@value"/>
			</h2>
			...
			<h2>Identifier / Metadata Reference Score: <xsl:value-of select="$identifierTotal"/>/<xsl:value-of select="$identifierMax"/></h2>
			<table width="95%" border="1" cellpadding="2" cellspacing="2">
				<tr>
				...
				<tr>
					...
					<td colspan="1" valign="top">The combination of the "naming authority" and the
						"id" should be a globally unique identifier for the dataset.<br/>
					</td>
				...
				<tr>
					...
					<td valign="top">Metadata_Convention</td>
				...
				<tr>
					...
					<td valign="top">This attribute provides a link to a complete metadata record for this dataset or the collection that contains this dataset. 
						<i>This attribute is not included in Version 1 of the Unidata Attribute Convention for Data Discovery. It is recommended here because a 
							complete metadata collection for a dataset will likely contain more information than can be included in granule formats. This 
							attribute contains a link to that information.</i></td>
					<td valign="top"/>
					<td valign="top"/>
				</tr>
			</table>
			...
			<table width="95%" border="1" cellpadding="2" cellspacing="2">
				...
				<tr>
					...
					<td valign="top">If you are following a guideline for the words/phrases in your
						"keywords" attribute, put the name of that guideline here.<br/>
					</td>
					<td valign="top">metadata/keyword@vocabulary</td>
					<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/gmd:title/gco:CharacterString
						<br/>
					</td>
				</tr>
				<tr>
					...
					<td valign="top">The name of the controlled vocabulary from which variable
						standard names are taken.<br/>
					</td>
				...
				<tr>
					...
					<td valign="top">Provides an audit trail for modifications to the original
						data.</td>
			...
			<table width="95%" border="1" cellpadding="2" cellspacing="2">
				...
				<tr>
					...
					<td rowspan="13" colspan="1" valign="top">Describes a simple latitude,
						longitude, and vertical bounding box. For a more detailed geospatial
						coverage, see the <a href="http://www.unidata.ucar.edu/software/netcdf-java/formats/DataDiscoveryAttConvention.html#suggested_geospatial">suggested geospatial attributes</a>.<br/> Further refinement of the
						geospatial bounding box can be provided by using these units and resolution
						attributes.<br/>
					</td>
				...
				<tr>
					...
					<td rowspan="4" colspan="1" valign="top">Describes the temporal coverage of the
						data as a time range.</td>
			...
			<table width="95%" border="1" cellpadding="2" cellspacing="2">
				...
				<tr>
					...
					<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:extent/gmd:EX_Extent/gmd:temporalElement/gmd:EX_TemporalExtent/gmd:extent/gml:TimePeriod/gml:beginPosition
						provides an ISO8601 compliant description of the time period covered by the
						dataset. This standard supports descriptions of <a href="http://en.wikipedia.org/wiki/ISO_8601#Durations">durations</a>.</td>
				</tr>
				<tr>
					<xsl:call-template name="showScore">
			...
			<table width="95%" border="1" cellpadding="2" cellspacing="2">
				...
				<tr>
					...
					<td rowspan="4" colspan="1" valign="top">The data creator's name, URL, and
						email. The "institution" attribute will be used if the "creator_name"
						attribute does not exist.<br/></td>
				...
				<tr>
					...
					<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:date/gmd:CI_Date/gmd:date/gco:Date<br/>
						/gmd:dateType/gmd:CI_DateTypeCode="creation"</td>
				</tr>
				<tr>
					<xsl:call-template name="showScore">
				...
				<tr>
					...
					<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:aggregationInfo/gmd:MD_AggregateInformation/gmd:aggregateDataSetName/gmd:CI_Citation/gmd:title/gco:CharacterString<br/>
						DS_AssociationTypeCode="largerWorkCitation" and
						DS_InitiativeTypeCode="project"</td>
				</tr>
				<tr>
					<xsl:call-template name="showScore">
					...
					<td valign="top">A place to acknowledge various type of support for the project
						that produced this data.<br/></td>
			...
			<table border="1">
				...
				<tr>
					...
					<td rowspan="2" colspan="1" valign="top">The name and role of any individuals or
						institutions that contributed to the creation of this data.<br/></td>
			...
			<table border="1">
				<tr>
					...
					<td rowspan="3" colspan="1" valign="top">The data publisher's name, URL, and
						email. The publisher may be an individual or an institution.</td>
			...
			<table width="95%" border="1" cellpadding="2" cellspacing="2">
				...
				<tr>
					...
					<td valign="top">A textual description of the processing (or quality control)
						level of the data.<br/></td>
				...
				<tr>
					...
					<td valign="top">/gmi:MI_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:spatialRepresentationType/gmd:MD_SpatialRepresentationTypeCode<br/>
						May need some extensions to this codelist. Current values: vector, grid,
						textTable, tin, stereoModel, video.</td>
				</tr>
			</table>
