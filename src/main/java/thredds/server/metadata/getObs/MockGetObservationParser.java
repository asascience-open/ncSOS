package thredds.server.metadata.getObs;
                ...
                if (isMultiTime() == false) {
                    for (int i = 0; i < timeVarLength; i++) {
                        ...
                        else //search the data time indexs for closest request
                        {
                                ...
                                int localst = WmsUtils.findNearestTimeIndex(ldt, st);
                                int localen = WmsUtils.findNearestTimeIndex(ldt, en);
